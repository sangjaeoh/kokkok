...
public class TipsDto {
	...
	public String toString() {
		return "TipsDto [seq=" + seq + ", bcode=" + bcode + ", userid=" + userid + ", subject=" + subject + ", content="
				+ content + ", logtime=" + logtime + ", updatetime=" + updatetime + ", recommcount=" + recommcount
				+ ", wishcount=" + wishcount + ", hit=" + hit + ", cname=" + cname + ", ccode=" + ccode + ", bname="
				+ bname + ", tseq=" + tseq + ", tname=" + tname + ", tcontent=" + tcontent + "]";
	}
